        ...
        steps {
          script {
            ...
            archiveArtifacts 'target/*.jar'
              // hygieiaTestPublishStep buildStatus: 'Unstable', testApplicationName: 'MyApp', testEnvironmentName: 'QA', testFileNamePattern: 'TEST-*.xml', testResultsDirectory: '**/target/surefire-reports/', testType: 'Unit'
